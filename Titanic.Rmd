...
We can use all the variables, but these incomplete variables. 
...
```{r}
train[is.na(train$Age) & train$SibSp > 0 & train$Title == "Master.", c("Sex","Age")]
...
for (i in (1)) {
    ...
    TitanicRF <- randomForest(Survived ~ Pclass + Sex + Fare + Age, 
