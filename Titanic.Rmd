...
We can see a missing info in Fare varible for test dataset.
We need to set a guess price for this observation. Options are: minimun price, maximum price, average price.
...
test[153, "Fare"] <- 8
test[150:158,]
train[train$Pclass == 3 & train$Embarked == "S" & train$Age > 50, "FARE" ]
train[694,]
